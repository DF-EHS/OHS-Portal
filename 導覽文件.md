...
**版本：** 2.0　　**日期：** 2026-06-30　　**維護：** 賴佑毓 / 人力資源部

---

## 一、系統概述

大豐環保科技職業安全衛生入口網站（OHS Portal）是整合公司各項職安衛管理功能的內部數位平台，目前上線功能涵蓋 **20 個系統模組**、**5 套互動教材**及 3 個 AI 快捷工具，供職安管理人員、現場主管及全體員工日常使用。
...
側邊欄依功能性質分為七個分區，共 20 個入口（含 2 個外部系統連結）。

### 3.1 法規合規

| 系統 | 路徑 | 主要功能 |
|------|------|---------|
| 法規鑑別查詢系統 | `law/` | 查詢適用之職安衛法規、法條內容與合規狀態；支援條文搜尋與鑑別清單匯出；內建法規問答機器人即時解答條文疑問 |
...
| 熱危害風險即時查詢 | `heat/` | GPS 定位取得最近氣象站即時溫濕度，計算 WBGT，依勞動部四級分類顯示風險等級與防護建議 |
...
| 承攬商管理系統 | `contract/` | 承攬商進場前依序完成危害告知確認、安全承諾書及工作許可證申請，全程電子化存檔供職安人員審核 |

### 3.5 制度文件

| 系統 | 路徑 | 主要功能 |
|------|------|---------|
| 安全衛生委員會報告 | `committee/` | 依年度與季度快速調閱職安衛委員會季報，包含安全改善成果、管理數據與各項決議追蹤 |
| 職業安全衛生計畫書 | `plans/` | 彙整年度職安衛計畫書及各項專項計畫，包含高氣溫熱危害預防、特殊作業等計畫文件 |
...
├── harassment/             # 不法侵害防治系統
├── maternity/              # 母性健康保護系統
│   └── apps-script.gs      #   GAS 後端原始碼（人員名冊/自我評估/危害評估/面談調整）
│
