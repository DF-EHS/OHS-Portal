...
2. 缺血風險數值：報告中 10 年弗雷明漢風險分數，**必須回傳百分比格式**（例如「5%」「12%」「3.5%」）。若報告上是小數（如 0.05），請乘以 100 後加上 % 符號（→「5%」）；若無直接數值，依血壓、血糖、血脂、年齡、性別估算後填入
